...
export const Map = ({ markerCoords }: { markerCoords: [number, number] }) => {
  // Example usage:
  const [mappedX, mappedY] = mapLatLonToXY(markerCoords[1], markerCoords[0]);
  ...
  return (
    ...
    >
      ...
      />
      <circle className=" fill-red-500" cx={mappedX} cy={mappedY} r="5" />
    </svg>
  );
};
